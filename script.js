    ...
    //     var privatedata = "develops";
    //     this.publicdata = "vishnu" + privatedata;
    //     this.publicfunction = function(){
    //         console.log("Public Data is :"+publicdata);
    //     }
    //     return this;
    // })();


    // var shouter = (function shouter(){
    ...
    /**
     * ?The ‘this’ keyword is an extremely powerful tool for programmers. Tracking and using ‘this’ can be quite confusing at times. Luckily there are methods to help keep ‘this’ simple.
    ...
    say2(); // logs "Hello Bob"
     ...
     /**
     * ?Here say2 is assigned a referance of  the anonymos function of console.log . So saHello2('bob') passes the name , makes of it some use in text. But only return the anonomous function to sa2.
     * ?So technically after function return name , text everything should have been destroyed. Since it only has access to the anynumous function it just returned , not the global variables of the parent 
